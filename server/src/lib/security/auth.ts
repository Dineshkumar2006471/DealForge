...
const { admin, db } = require('../firebase/admin') as { admin: any; db: any };
...
export async function requireManager(req: AuthenticatedRequest, _res: Response, next: NextFunction): Promise<void> {
  try {
