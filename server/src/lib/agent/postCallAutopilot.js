...
async function runPostCallAutopilot(context) {
  ...
  await writeAuditEvent({
    ...
    trigger: 'Post-call autonomous assessment completed',
    actionResult: { dealHealth: result.dealHealth.score, nextBestAction: result.nextBestAction.action, verified: true },
  });
  return result;
}
