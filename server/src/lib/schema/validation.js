...
const toolSchemas = {
  ...
  update_deal_state: z
    .object({
      ...
      meddic_pillar: z.enum(MEDDIC).optional(),
      meddic_status: z.enum(['confirmed', 'unknown', 'not_asked']).optional(),
      new_stage: z.enum(STAGES).optional(),
    })
    .strict()
    .refine(
