...
test('Frontend Modernization: React 18 + Vite 5 Build & Components Contract', async (t) => {
  ...
  await t.test('Production Build Artifacts: dist/index.html exists and mounts React SPA root', () => {
  ...
  await t.test('Production Bundles: dist/assets contains hashed JS and CSS bundles', () => {
  ...
  await t.test('Backward Compatibility: static HTML pages and public assets are preserved in dist', () => {
